...
def _get_digit_model():
    ...
    if _DIGIT_MODEL is None:
        ...
        try:
            ...
            import gesture_app.cnntrain_mnist as cm
...
def written_number(ui=None):
    ...
    while cap.isOpened():
        ...
        # 在图像上显示识别结果（像number_gesture.py那样的大字体黄色显示）
        if prediction_text and prediction_text != "识别失败":
            # 大字体显示数字（像number_gesture.py那样）
